          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <h1 className="text-5xl lg:text-7xl font-bold leading-tight">
                Health-Care by
                <span className="text-emerald-400 block">MediCare</span>
              </h1>

              <p className="text-xl lg:text-2xl font-medium text-emerald-300">Team MediCare</p>

              <p className="text-lg lg:text-xl leading-relaxed max-w-3xl mx-auto text-gray-200">
