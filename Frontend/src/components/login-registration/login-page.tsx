      ...
      <div className="w-full max-w-5xl mx-auto">
        <div className="bg-white/90 backdrop-blur rounded-xl shadow-xl overflow-hidden">
          <div className="grid md:grid-cols-2">
            ...
            <div className="relative hidden md:block animate-fade-slide-left animation-delay-500">
              <img
              ...
              />
              <div className="absolute inset-0 bg-gradient-blue-teal-overlay" />
              <div className="relative z-10 p-8 h-[420px] flex flex-col justify-center text-white">
                <div className="text-center space-y-4">
                  <h1 className="text-3xl font-bold leading-tight">Welcome to MediCare</h1>
                  <p className="text-base font-semibold bg-gradient-to-r from-sky-300 to-teal-300 bg-clip-text text-transparent">
                    Healthcare Team
                  </p>
                  <p className="text-sm leading-relaxed text-gray-100">
                    We are here to provide you with the best healthcare services. Sign in to access your medical records
                    and appointments.
                  </p>
                </div>
              </div>
            ...
            <div className="p-6 sm:p-8 flex items-center justify-center animate-fade-slide-right animation-delay-1000">
