...
// Define gradient text classes
const textGradientBlueTeal = "bg-gradient-to-r from-blue-600 via-teal-500 to-teal-600 bg-clip-text text-transparent"
...
export default function PatientProfile() {
  return (
    <div className="max-w-4xl mx-auto">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gradient-blue-teal mb-2 drop-shadow-lg">My Profile</h1>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-white/20">
            <div className="flex justify-between items-center mb-6">
              ...
              {/* Update edit button to blue→blue */}
          ...
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-white/20">
            <div className="flex justify-between items-center mb-6">
              ...
              {/* Update update button to blue→teal for consistency */}
              <button className="bg-gradient-to-r from-teal-500 to-teal-600 text-white px-4 py-2 rounded-lg hover:from-teal-600 hover:to-teal-700 transition-all flex items-center gap-2">
                <Edit className="w-4 h-4" />
                Update
              </button>
            </div>
            ...
            <div className="mt-6">
              ...
              <textarea
                ...
                className="w-full px-3 py-2 border border-gray-200 rounded-lg bg-gray-50 h-20"
                readOnly
              />
            </div>
          </div>
