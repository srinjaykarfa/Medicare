...
const textGradientBlueTeal = "bg-gradient-to-r from-blue-600 via-blue-700 to-teal-500 bg-clip-text text-transparent"
...
export default function PatientHealth() {
  return (
    <div className="max-w-6xl mx-auto">
      {/* Header */}
      <div className="mb-8">
        <h1 className={`text-3xl font-bold ${textGradientBlueTeal} mb-2 drop-shadow-lg`}>Health Metrics</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="bg-gradient-to-br from-blue-500 to-blue-600 text-white p-6 rounded-2xl shadow-xl">
          ...
          <div className="text-blue-100 text-sm">Normal</div>
        </div>
        ...
        <div className="bg-gradient-to-br from-teal-500 to-teal-600 text-white p-6 rounded-2xl shadow-xl">
          ...
          <div className="text-teal-100 text-sm">Optimal</div>
        </div>
        ...
        <div className="bg-gradient-to-br from-teal-500 to-teal-600 text-white p-6 rounded-2xl shadow-xl">
          ...
          <div className="text-teal-100 text-sm">Stable</div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-white/20">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
              ...
              <span className="text-teal-600 font-medium">↓ 2 lbs this month</span>
            </div>
            <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
            ...
            <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
              ...
              <span className="text-teal-600 font-medium">↓ Improving</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-white/20">
          ...
          <button className="w-full mt-4 bg-gradient-to-r from-teal-500 to-teal-600 text-white py-2 rounded-lg hover:from-teal-600 hover:to-teal-700 transition-all">
            Add New Reading
          </button>
        </div>
      </div>
